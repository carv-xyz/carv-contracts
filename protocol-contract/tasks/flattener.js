...
subtask(
  "flattener:get-flattened-sources",
  "Returns all contracts and their dependencies flattened"
)
  .addOptionalParam("files", undefined, undefined, types.any)
  .addOptionalParam("output", undefined, undefined, types.string)
  .setAction(async ({ files, output }, { run }) => {
    const dependencyGraph = await run("flattener:get-dependency-graph", {
      files,
    });
...
subtask("flattener:get-dependency-graph")
  .addOptionalParam("files", undefined, undefined, types.any)
...
task(
  "flattener",
  "Fixed-up solidity contract flattener"
)
  ...
  .setAction(async ({ files, output }, { run }) => {
    console.log(
      await run("flattener:get-flattened-sources", {
        files,
        output,
      })
    );
